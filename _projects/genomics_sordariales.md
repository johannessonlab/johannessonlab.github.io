...
Using a phylogenomic approach, we reconstruct the phylogenetic tree of Sordariales, and use it to explore genome evolution in the order. Within Sordariales, the Chaetomiaceae hosts a high number of thermophilic species, and one aims of this project is to investigate a possible link between optimal growth temperature and evolutionary rates.
